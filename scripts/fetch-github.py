...
GITHUB_CACHE_PATH = "/tmp/media-digest-github-cache.json"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Parallel GitHub releases fetcher for media-digest. "
...
Environment Variables:
    ...
    if not args.output:
        fd, temp_path = tempfile.mkstemp(prefix="media-digest-github-", suffix=".json")
        os.close(fd)
